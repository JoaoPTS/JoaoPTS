...
if (isset($_SESSION['msg'])) {
	echo "<script> alert('$_SESSION[msg]')</script> <script> location.replace('login.php'); </script>";
	unset($_SESSION['msg']);
}
							...
							<div class="d-flex  flex-column flex-lg-row align-items-center">
								<ul class="navbar-nav">
									...
									<li class="nav-item active">
										<a class="nav-link" href="Loja.php">Loja <span class="sr-only">(current)</span></a>
									</li>
		...
		<div class="container">
			...
			<div class='layout_padding2-top '>
				<div class='row'>
                    ...
                    <!-- Ajustando o tamanho da imagem com width e height -->
                    <img src='images/{$produto['imagem']}' class='card-img-top ' alt='{$produto['nome']}' height='300'>
                    <div class='card-body'>
                        <h5 class='card-title'>{$produto['nome']}</h5>
                        <p class='card-text'>{$produto['descricao']}</p>
                        <p class='text-success'>R$ {$produto['preco']}</p>
                        <a href='./database/routes/cartAdd.php?id={$produto['id']}' class='btn btn-primary'>Adicionar ao Carrinho</a>
