...
if (isset($_SESSION['msg'])) {
	echo "<script> alert('$_SESSION[msg]')</script> <script> location.replace('forca.php'); </script>";
	unset($_SESSION['msg']);
}
				...
				<div class="container">
					...
					<div class="box">
						...
						<div class="layout_padding2-top">
							...
							<h4>Treino de Força Dinâmico (Exemplo para 4 dias por semana)</h4>
							<br><br>
							<h5>Segunda-Feira</h5>
							...
							<table>
								...
								<tr>
									<td>Deadlift (Levantamento terra) </td>
									<td>4</td>
									<td>5-6</td>
									<td>90 segundos</td>
								</tr>
								<tr>
									<td>Flexão de braços explosiva</td>
									<td>4</td>
									<td>10-12</td>
									<td>60 segundos</td>
								</tr>
								<tr>
									<td>Pull-up (barra fixa)</td>
									<td>4</td>
									<td>6-8</td>
									<td>90 segundos</td>
								</tr>
							...
							<table>
								...
								<tr>
									<td>Puxada frontal (Lat Pulldown) </td>
									<td>4</td>
									<td>8-10</td>
									<td>60 segundos </td>
								</tr>
								<tr>
									<td>Desenvolvimento de ombro com barra </td>
									<td>4</td>
									<td>6-8</td>
									<td>90 segundos</td>
								</tr>
								...
								<tr>
									<td>Prancha com toque no ombro</td>
									<td>3</td>
									<td>20-30</td>
									<td>60 segundos</td>
								</tr>
							...
							<table>
								...
								<tr>
									<td>Agachamento frontal com barra </td>
									<td>4</td>
									<td>6-8</td>
									<td>90 segundos </td>
								</tr>
								<tr>
									<td>Hip Thrust (elevação de quadril) </td>
									<td>4</td>
									<td>8-10</td>
									<td>90 segundos</td>
								</tr>
								<tr>
									<td>Jumping Lunges (afundo com salto)</td>
									<td>3</td>
									<td>12-15</td>
									<td>60 segundos</td>
								</tr>
								<tr>
									<td>Dumbbell Snatch (arranco com haltere)</td>
									<td>4</td>
									<td>6-8</td>
									<td>90 segundos</td>
								</tr>
							...
							<table>
								...
								<tr>
									<td>Levantamento Terra Romeno (com halteres ou barra) </td>
									<td>4</td>
									<td>8-10</td>
									<td>90 segundos </td>
								</tr>
								<tr>
									<td>Barbell Row (Remada com barra) </td>
									<td>4</td>
									<td>6-8</td>
									<td>90 segundos</td>
								</tr>
								<tr>
									<td>Push-up com palmas (explosivo)</td>
									<td>3</td>
									<td>8-10</td>
									<td>60 segundos</td>
								</tr>
								<tr>
									<td>Kettlebell Clean and Press</td>
									<td>4</td>
									<td>6-8</td>
									<td>90 segundos</td>
								</tr>
