...
if (isset($_SESSION['msg'])) {
	echo "<script> alert('$_SESSION[msg]')</script> <script> location.replace('register.php'); </script>";
	unset($_SESSION['msg']);
}
			...
			<div class="container">
				<div class="custom_nav2">
                    ...
                    <li class='nav-item active'>
                      <a class='nav-link' href='register.php'>Cadastro <span class='sr-only'>(current)</span></a>
                    </li>
                    <li class='nav-item'>
	...
	<section class="cadastro_section layout_padding">
		<div class="container">
			...
			<div class="layout_padding2-top">
				<div class="row">
					<div class="col-md-6 ">
						<form action="database/routes/userPost.php" method="POST">
							<div class="cadastro_form-container">
								<div>
									<div>

										<h4><label>Nome:</label></h4>
										<input type="text" placeholder="Digite o nome" name="name" /><br><br>
									</div>
									<div>
										<h4><label>Usuário:</label></h4>
										<input type="text" placeholder="Digite o usuário" name="username" /><br><br>
									</div>
									<div>
										<h4><label>E-mail:</label></h4>
										<input type="email" placeholder="Digite seu e-mail" name="email" /><br><br>
									</div>
									<div>
									...
									<div>
										<h4><label>Confirmar senha:</label></h4>
										<input type="password" placeholder="Confirmar a senha" name="confirm" /><br>
									</div>
									<div class="mt-5">
